import styles from '@/components/sections/appsSections/mainApps/mainApps.module.scss';
    ...
    <section id="mainApps-section" className={styles.section}>
      ...
      <div className={styles.texts}>
        <div className={styles.title}>
          ...
          <span className={styles.titleLine2}>Plan B Ecosystem</span>
        </div>
        <div className={styles.subtitle}>
          Projects leveraging the power of Plan B
        </div>
      </div>
